...
const ReorderLevelStatusReport = () => {
  ...
  const getStoreSKUResult = ReportsApi.useGetProductBalancesQuery({
    // Location,
  });
...
export default ReorderLevelStatusReport;
