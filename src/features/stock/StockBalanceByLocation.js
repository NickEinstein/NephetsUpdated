...
const StockBalanceByLocation = () => {
  ...
  const getStoreLocationResult = ReportsApi.useGetStocksByLocationQuery({
    locationId: formData.store,
    // Location,
  });
  const storeSKU = getStoreLocationResult.data;

  const getStoreResult = UserApi.useGetStoreLocationsQuery({
    //   ProjectType,
    //   Location,
  });
...
export default StockBalanceByLocation;
