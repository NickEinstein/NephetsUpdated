    ...
    <div className="container mx-auto p-4 w-full px-[10%]">
      ...
      <div className="flex gap-2 items-end mb-4 justify-center">
        ...
        <TextField
          ...
          variant="standard"
          value={moment(props?.dataz&& props?.dataz[0]?.sittingDate).format("l")}
          className="flex items-center text-center font-bold text-red-600 w-[90px]"
        />
        <Typography>
